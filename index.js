/**!
 * digest-header-cryptojs - index.js
 *
 * Copyright(c) kssfilo and other contributors.
 * based on fengmk2's nodejs version
 * MIT Licensed
 *
 * Authors:
 *   kssfilo <kssfilo@gmail.com> (http://kssfilo.github.com)
 */
...
function digestAuthHeader(method, uri, wwwAuthenticate, userpass) {
  ...
  var cnonce = cryptojs.util.bytesToHex(cryptojs.util.randomBytes(8));

  var ha1 = cryptojs.MD5(userpass[0] + ':' + opts.realm + ':' + userpass[1]);
  var ha2 = cryptojs.MD5(method.toUpperCase() + ':' + uri);
